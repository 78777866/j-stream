# NEON - Premium Streaming Platform
...
- `NEXT_PUBLIC_SITE_NAME`: Your site name (e.g., `NEON`)
...
NEON is a premium streaming platform designed to provide the ultimate movie and TV show watching experience. Built with modern web technologies, it offers fast, reliable streaming with a beautiful, intuitive interface.
